...
CREATE TABLE IF NOT EXISTS problems (
    ...
    deep_link   TEXT,
    -- Global (shared) flags kept here until Phase 4 migrates them to user_problems.
...
CREATE TABLE IF NOT EXISTS contests (
    ...
    -- Shared flag kept here until Phase 4/6 introduce per-user contest state.
...
-- Leaderboard snapshot (read-only in the API, populated by admin/import).
CREATE TABLE IF NOT EXISTS contest_leaderboard (
    ...
    score            INT,
    penalty          INT,
    problems_solved  TEXT,         -- comma-separated problem labels, e.g. "A,B,C"
